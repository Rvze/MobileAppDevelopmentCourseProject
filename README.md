...
2) auth-proxy – компонент, отвечающий за аутентификацию/авторизацию и проксирование запросов от клиента
3) core-stuff – компонент, отвечающий за товары: хранение, изменение, чтение
4) core-notification – компонент, отвечающий за обработку и отправку уведомлений
...
Сервис должен ограничивать нагрузку в 10 RPS на каждый эндпоинт. Если допустимое количество запросов превышено, сервис
